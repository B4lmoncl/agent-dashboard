            ...
            <div className="relative">
              ...
              {(expandedCampaign.rewards.xp > 0 || expandedCampaign.rewards.gold > 0 || expandedCampaign.rewards.title) && (
                <div className="mt-4 flex items-center gap-3 flex-wrap">
                  ...
                  {expandedCampaign.rewards.gold > 0 && <span className="text-xs px-2 py-0.5 rounded inline-flex items-center gap-1" style={{ background: "rgba(251,191,36,0.12)", color: "#fbbf24", border: "1px solid rgba(251,191,36,0.25)" }}><img src="/images/icons/currency-gold.png" alt="" width={14} height={14} style={{ imageRendering: "smooth" }} onError={e => { e.currentTarget.style.display = "none"; }} /> {expandedCampaign.rewards.gold}</span>}
