    ...
    <div className="space-y-6 tab-content-enter">
      ...
      {createOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.7)" }} onClick={() => setCreateOpen(false)}>
          <div className="rounded-2xl p-6 w-full max-w-[calc(100vw-2rem)] sm:max-w-lg max-h-[90vh] overflow-y-auto" style={{ background: "#0d1017", border: "1px solid rgba(139,92,246,0.4)", boxShadow: "0 0 60px rgba(139,92,246,0.2)", scrollbarWidth: "thin" as const, overscrollBehavior: "contain" }} onClick={e => e.stopPropagation()}>
