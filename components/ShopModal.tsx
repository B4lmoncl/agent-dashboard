      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs inline-flex items-center gap-1" style={{ color: "rgba(255,255,255,0.3)" }}>{userName} · <img src="/images/icons/currency-gold.png" alt="" width={20} height={20} style={{ imageRendering: "smooth" }} onError={e => { e.currentTarget.style.display = "none"; }} /> {gold} gold</p>
          </div>
