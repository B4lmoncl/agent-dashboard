          ...
          {(() => {
            ...
            const portrait = portraitSrc ? (
              <img
                src={portraitSrc}
                alt={companionName}
                style={{ width: ringSize.w, height: ringSize.h, imageRendering: "smooth", borderRadius: 4, border: `2px solid ${cColor.border}`, boxShadow: companionGlow ? `0 0 24px rgba(${cColor.accentRgb},0.6), 0 0 48px rgba(${cColor.accentRgb},0.3)` : `0 0 12px rgba(${cColor.accentRgb},0.15)`, flexShrink: 0, transition: "box-shadow 0.5s ease" }}
              />
            ) : (
              <div style={{
