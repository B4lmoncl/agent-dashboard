                ...
                <div className="space-y-2 overflow-y-auto flex-1">
                  {[
                    ...
                    <div key={c.name}>
                      ...
                      >
                        <img src={c.iconSrc} alt="" width={24} height={24} className={c.key === "stardust" ? "premium-stardust" : c.key === "runensplitter" ? "premium-rune-shards" : ""} style={{ imageRendering: "smooth" }} onError={(e) => { const t = e.currentTarget; t.style.opacity = "0"; t.style.width = "0"; t.style.overflow = "hidden"; }} />
