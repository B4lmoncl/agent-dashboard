...
const AGENT_META = {
  ...
  forge: { avatar: 'x', color: '#f59e0b', role: 'Idea Smith', description: 'Silent craftsman' },
};

const NPC_META = {
  dobbie:       { avatar: 'x', color: '#ff6b9d', role: 'Cat Overlord', description: 'Dobbie the demanding house cat. His requests are not optional. Resistance is futile.' },
  'npc-dobbie': { avatar: 'x', color: '#ff6b9d', role: 'Cat Overlord', description: 'Dobbie the demanding house cat. His requests are not optional. Resistance is futile.' },
};
