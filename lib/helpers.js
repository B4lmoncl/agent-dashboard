...
function onQuestCompletedByUser(userId, quest) {
  ...
  let xpEarned = Math.round(xpBase * (xpMulti || 1) * (gearBonus || 1) * (companionBonus || 1) * (bondBonus || 1) * (hoardingMalus || 1) * (passiveXpBonus || 1) * (legendaryMods.xpBonus || 1) * (activeXpBuf || 1) * (nthBonus || 1) * (varietyBonus || 1) * (critMulti || 1) * (armorTraitMod || 1) * dailyDiminishing);
