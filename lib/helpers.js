...
function onQuestCompletedByUser(userId, quest) {
  ...
  if (droppedLoot) {
    ...
    // Enrich loot with richer template data (desc, flavorText, effect) so the
    // frontend hover tooltip can display the full item card. lootTables entries
    // often lack these fields but itemTemplates does.
