...
/**
 * Create a gear instance from a unique named item template (Diablo-style).
 * Unique items have FIXED stats (not random rolled) and 3 sockets.
 */
function createUniqueInstance(uniqueTemplate) {
  return {
    ...
    legendaryEffect: uniqueTemplate.legendaryEffect || null,
    setId: null,
