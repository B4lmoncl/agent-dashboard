...
function onQuestCompletedByUser(userId, quest) {
  ...
  const xpEarned = Math.round(xpBase * xpMulti * gearBonus * companionBonus * bondBonus * hoardingMalus * passiveXpBonus * legendaryMods.xpBonus * activeXpBuf * nthBonus * varietyBonus * critMulti);
